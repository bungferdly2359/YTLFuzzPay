...
const OnboardingPage = props => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Button style={styles.fbButton} type="primary" text="Sign in with Facebook" onPress={() => props.signInWithFacebook().then(gotoMain)} />
      <Button style={styles.googleButton} type="primary" text="Sign in with Google" onPress={() => props.signInWithGoogle().then(gotoMain)} />
    </View>
  );
};

export default connect(null, { signInWithFacebook, signInWithGoogle })(OnboardingPage);
